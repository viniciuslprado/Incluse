...
export default function FaqFloating() {
  ...
  return (
    <button
      ...
      className="hidden md:fixed md:flex bottom-6 right-6 z-50 bg-incluse-primary text-white p-4 rounded-full shadow-lg hover:shadow-2xl transition-all duration-200 items-center justify-center dark:bg-green-600 dark:hover:bg-green-700"
    >
