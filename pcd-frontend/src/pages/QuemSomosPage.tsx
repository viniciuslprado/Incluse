    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <main className="max-w-5xl mx-auto p-6">
        ...
        <section className="mt-6">
          ...
          <p className="text-gray-700 dark:text-gray-300">Promover a inclusão profissional por meio de tecnologia acessível, parcerias com empresas e informação.</p>
        </section>
        <section className="mt-6">
          <h2 className="text-2xl font-semibold mb-2">Contato</h2>
          <p className="text-gray-700 dark:text-gray-300">Se quiser contribuir com a plataforma ou listar sua empresa, entre em contato pelo e-mail: contato@incluse.local</p>
        </section>
      </main>
      <Footer />
    </div>
