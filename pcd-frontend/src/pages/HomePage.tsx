...
function Stats({ onAbrirChat }: { onAbrirChat: () => void }) {
  return (
    <div className="bg-incluse-bg-neutral dark:bg-gray-800 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-incluse-text dark:text-white mb-4">
            Impacto Incluse
          </h2>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <Link to="/vagas" className="text-center group cursor-pointer block">
            ...
            <div className="text-4xl font-bold text-incluse-primary dark:text-incluse-accent mb-2">15+</div>
          ...
          <Link to="/empresas" className="text-center group cursor-pointer block">
            ...
            <div className="text-4xl font-bold text-incluse-secondary dark:text-incluse-secondary-dark-mode mb-2">3</div>
...
export default function HomePage() {
  ...
  useEffect(() => {
    async function carregarVagas() {
      try {
        // Por enquanto, vamos carregar vagas da empresa 1
        // Depois implementaremos uma API para listar todas as vagas
        const vagasData = await api.listarVagas(1);
        setVagas(vagasData);
      } catch (err) {
